...
# SYSCOIN: The post-BLS tidy image no longer installs GMP.
# export PACKAGES="clang-15 libclang-15-dev llvm-15-dev libomp-15-dev clang-tidy-15 jq bear cmake libevent-dev libboost-dev libminiupnpc-dev libnatpmp-dev libzmq3-dev systemtap-sdt-dev libqt5gui5 libqt5core5a libqt5dbus5 qttools5-dev qttools5-dev-tools libqrencode-dev libsqlite3-dev libdb++-dev"
