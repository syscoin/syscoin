...
class PrioritiseTransactionTest(syscoinTestFramework):
    ...
    def setup_network(self):
        ...
        self.nodes.append(start_node(1, self.options.tmpdir, ["-debug", "-printpriority=1"])) # TODO move this to extra_args when syscoin #10198 gets backported
        connect_nodes(self.nodes[0], 1) # TODO remove this when syscoin #10198 gets backported
