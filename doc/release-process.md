...
* Update hardcoded [seeds](/contrib/seeds/README.md). TODO: Give example PR for Syscoin
...
space *do not upload these to the syscoin.org server*.
...
- Announce the release:
  ...
  - Optionally Discord, twitter, reddit /r/Syscoinpay, ... but this will usually sort out itself
