...
backwards-compatible with pre-0.12 versions of Syscoin Core or other software:
...
Switched to syscoin Core version 0.10 - https://syscoin.org/en/release/v0.10.0
