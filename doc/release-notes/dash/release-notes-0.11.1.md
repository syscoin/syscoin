...
and a new version of enforcement compatible with the newer syscoin architechure.
Latest release in 0.11.1.x tree is v0.11.1.26, which is rebranding Darkcoin to Syscoin.
...
- fix coin control crash https://github.com/syscoin/syscoin/pull/5700
