...
``` bash
brew install automake libtool boost pkg-config libevent curl-openssl cmake
```
...
You can deploy a `.zip` containing the Syscoin Core application using `make deploy`.
