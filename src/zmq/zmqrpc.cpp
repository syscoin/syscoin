                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::STR, "addresssub", /*optional=*/true, "Address of the subscriber, omitted if there is no subscriber assigned to this notification"}, // SYSCOIN: Expose the NEVM request endpoint.
