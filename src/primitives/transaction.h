...
// SYSCOIN: post-quantum global operator and fixed child-root registration.
const int SYSCOIN_TX_VERSION_PQ_GLOBAL_KEY = 86;
const int SYSCOIN_TX_VERSION_PQ_RECOVERY_READINESS = 87;
