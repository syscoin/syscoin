...
BOOST_AUTO_TEST_CASE (generate_certoffernew)
{
	...
	OfferNew("node1", "sysrates.peg", "category", "title", "1", "0.05", "description", "USD", certguid1a, "0", "2");
	// generate a cert offer if accepting BTC OR SYS
	OfferNew("node1", "sysrates.peg", "category", "title", "1", "0.05", "description", "USD", certguid1a, "0", "3");
