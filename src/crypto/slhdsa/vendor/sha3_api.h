 ...
 *
 * Modified by the Syscoin project: prefix vendored C symbols.
 */
...
/* Avoid collisions with other SHA-3/SHAKE implementations. */
#define keccak_f1600 syscoin_slhdsa_vendor_keccak_f1600
#define sha3_init syscoin_slhdsa_vendor_sha3_init
#define sha3_update syscoin_slhdsa_vendor_sha3_update
#define shake syscoin_slhdsa_vendor_shake
#define shake_out syscoin_slhdsa_vendor_shake_out
