...
bool CheckTransaction(const CTransaction& tx, TxValidationState& state)
{
    ...
    // SYSCOIN BEGIN: Modify Bitcoin's size rejection to distinguish committed
    // transaction oversize from replaceable PoDA sidecar oversize.
    // Bitcoin original:
    ...
    // SYSCOIN END: Distinguish committed and PoDA sidecar size failures.
