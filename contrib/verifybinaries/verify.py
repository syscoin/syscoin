...
github.com and syscoin-binaries.thepasta.org and compares them.
...
HASHFILE = "hashes.tmp"
HOST1="https://github.com/syscoin/syscoin/releases/download/v"
...
def main(args):
    ...
    if not success:
        print("github.com failed to provide signature file, "
              "but syscoin-binaries.thepasta.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("github.com and syscoin-binaries.thepasta.org signature files were not equal?")
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the Syscoin Core binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))
